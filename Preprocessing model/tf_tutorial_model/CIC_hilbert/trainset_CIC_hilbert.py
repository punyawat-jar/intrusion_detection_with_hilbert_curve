...
def process_and_save_image(i, df_slice, loaded_curve, drop_fea, size, n_windows):
    ...
    img.save(f'/home/s2316002/Project2/Dataset/CIC/image_train/image_{i}.png')
    print(f'Image {i}/{n_windows} -- Done')
    ...
    if counter.value % 5000 == 0 or counter.value <2:
        ...
        content = f'Finished processing image {counter.value}. Progress: {progress * 100:.2f}% \n{progress_bar}'
...
image_files = glob.glob('/home/s2316002/Project2/Dataset/CIC/image_train/image_*.png')
send_discord_message(f'- CIC Hillbert starting -')
print(f'- CIC Hillbert starting -')
